...
export const modelSelectorTriggerVariants = cva(
  "focus-visible:ring-ring/50 flex w-fit items-center justify-between gap-2 overflow-hidden rounded-xl text-sm whitespace-nowrap transition-colors outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      variant: {
        outline:
...
function ModelSelectorItem({
  ...
  return (
    ...
    >
      ...
      {isSelected && (
        <span className="absolute inset-e-3 top-2.5 flex size-4 items-center justify-center">
...
function ModelSelectorEffort({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: ACK
    <div
